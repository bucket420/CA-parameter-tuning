...
for i, row in enumerate(params):
    setattr(process, 'pixelTracksCUDA' + str(i), cms.EDProducer('CAHitNtupletCUDAHIonPhase1',
    ...
    setattr(process, 'pixelTracksSoA' + str(i), cms.EDProducer('PixelTrackSoAFromCUDAHIonPhase1',
            mightGet = cms.optional.untracked.vstring,
            src = cms.InputTag('pixelTracksCUDA' + str(i)))
    )
    setattr(process, 'pixelTracks' + str(i), cms.EDProducer('PixelTrackProducerFromSoAHIonPhase1',

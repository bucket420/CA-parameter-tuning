...
tune_module = 'CAHitNtupletAlpakaPhase1Strip@alpaka'
from HLTrigger.Configuration.common import producers_by_type
npairs = 0
for mod in producers_by_type(process,tune_module):
    npairs = len(mod.phiCuts)
print(npairs)
for i, row in enumerate(params):
    setattr(process, 'pixelTracksSoA' + str(i), cms.EDProducer(tune_module,
            ...
            phiCuts = cms.vint32([int(row[i+6]) for i in range(npairs)]),

...
params = read_csv(options.parametersFile)# Auto generated configuration file
# using: 
# Revision: 1.19 
...
tune = 'offlineBeamSpot'
chain = ['"siPixelRecHitsPreSplitting@cuda"', '"pixelTracksSoA@cuda"', 'offlineBeamSpotToCUDA', 'pixelTracks', 'pixelTracksCUDA', 'pixelTracksSoA', 'siPixelRecHitsPreSplitting', 'siPixelRecHitsPreSplittingCUDA']
target = 'pixelTracks'
